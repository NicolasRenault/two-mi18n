...
If you don't want to install the command to your machine, you can download the script from below:

- Windows: [two-mi18n-helper-script-windows-amd64.exe](https://two-mi18n-helper-script.nicolasrenault.com/two-mi18n-helper-script-windows-amd64.exe)
- Linux: [two-mi18n-helper-script-linux-amd64](https://two-mi18n-helper-script.nicolasrenault.com/two-mi18n-helper-script-linux-amd64)
- Mac (Apple Silicon): [two-mi18n-helper-script-darwin-arm64](https://two-mi18n-helper-script.nicolasrenault.com/two-mi18n-helper-script-darwin-arm64)
- Mac (Intel): [two-mi18n-helper-script-darwin-amd64](https://two-mi18n-helper-script.nicolasrenault.com/two-mi18n-helper-script-darwin-amd64)
